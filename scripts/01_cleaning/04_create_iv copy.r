...
panel_aid_admin2 <- read_csv("01_panel_data/panel_aid_admin2_health.csv")
...
panel_aid_admin1 <- read_csv("01_panel_data/panel_aid_admin1_health.csv")
...
write_csv(panel_aid_admin2, "01_panel_data/panel_aid_admin2_health_fin.csv")
write_csv(panel_aid_admin1, "01_panel_data/panel_aid_admin1_health_fin.csv")
