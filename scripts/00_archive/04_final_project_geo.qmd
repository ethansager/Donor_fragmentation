...
countries_iso3 <- c("BEN", "BWA", "GHA", "MDG", "MLI", "MOZ", "MWI", "NAM", "SEN", 
"TZA", "ZAF", "ZMB", "ZWE")

panel_aid_admin1 <- read_csv("01_panel_data/panel_aid_admin1_new.csv")%>%
    filter(GID_0 %in% countries_iso3)

panel_aid_admin2 <- read.csv("01_panel_data/panel_aid_admin2_new.csv")%>%
    filter(GID_0 %in% countries_iso3)
...
#Fixed Effects
fe_hhi <- plm(mean_nl ~ lag(log(total_aid_admin1),1) * lag(frag_index_admin1,1) * mean_sgq_admin1 + ge_pct, 
